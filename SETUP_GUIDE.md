...
1. Copia el archivo `.env.example` (en el raíz) como `frontend/.env.local`
2. Abre `frontend/.env.local` en tu editor
...
- El archivo `.env.local` debe estar dentro de `frontend/` para que Next.js lo reconozca.
