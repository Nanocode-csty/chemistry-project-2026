      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-24">
          ...
          >
            ...
            <div className="flex items-center gap-6 mb-4 text-brand-muted">
          ...
          {investigaciones.length > 0 ? investigaciones.map((inv, idx) => (
            ...
            >
              ...
              <div className="p-10 flex-grow relative z-10">
                <div className="w-16 h-16 bg-white border-2 border-[#002A45] flex items-center justify-center text-[#002A45] mb-8 group-hover:bg-[#002A45] group-hover:text-white transition-all duration-500 shadow-sm group-hover:-translate-y-2">
                  <Microscope size={32} />
                </div>
                <h2 className="text-2xl font-display font-black text-[#002A45] mb-6 uppercase tracking-tight leading-tight group-hover:text-[#002A45] transition-colors">
                  {inv.titulo}
                </h2>
              ...
              <div className="p-10 pt-0 relative z-10">
                <Link
                  ...
                  className="inline-flex items-center gap-3 text-[11px] font-display font-black tracking-[0.2em] text-[#002A45] uppercase group-hover:gap-5 transition-all border-b-2 border-transparent hover:border-[#9ABE00]  pb-1"
                >
                  EXPEDIENTE COMPLETO <ArrowRight size={16} className="text-[#9ABE00] " />
                </Link>
              </div>
            </motion.div>
          )) : (
