  ...
  return (
    <main className="min-h-screen bg-brand-gray pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-24">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl text-[#002b45] font-display font-black uppercase tracking-tighter leading-none mb-8">
              TRANSFERENCIA<br />
              <span className="text-[#9ABE00] italic">TECNOLÓGICA</span>
            </h1>
            ...
            >
              ...
              <div className="p-10 flex-grow relative z-10">
                <div className="flex justify-between items-start mb-8">
                  ...
                  <span className="text-[10px] font-black text-slate-300 group-hover:text-[#9ABE00] uppercase tracking-widest transition-colors">{item.tecnologia}</span>
                </div>
                <h2 className="text-2xl font-display font-black text-[#002A45] uppercase mb-6 group-hover:text-[#002A45] transition-colors">{item.titulo}</h2>
                <p className="text-gray-600 mb-8 flex-grow">{item.descripcion}</p>
                {item.impacto && (
                  <div className="mb-8 p-4 bg-brand-light border-l-2 border-[#9ABE00] italic text-sm text-[#002A45] group-hover:bg-[#9ABE00]/10 transition-colors">
                    Impacto: {item.impacto}
                  </div>
                )}
                <Link href="/#contacto" className="inline-flex items-center gap-2 text-[11px] font-black tracking-widest text-[#9ABE00] uppercase hover:text-[#002A45] transition-colors border-b-2 border-transparent hover:border-[#9ABE00] pb-1">
            ...
            <>
              ...
              {[
                ...
                >
                  <div className="absolute top-0 right-0 w-32 h-32 bg-brand-light -mr-16 -mt-16 rounded-full group-hover:bg-[#9ABE00]/5 group-hover:scale-150 transition-all duration-700" />
                  <div className="p-10 flex-grow relative z-10">
                    <div className="w-16 h-16 bg-white border-2 border-[#002A45] flex items-center justify-center text-[#002A45] group-hover:bg-[#002A45] group-hover:text-white transition-all duration-500 shadow-sm group-hover:-translate-y-2 mb-8">
                      <item.icon size={32} />
                    </div>
                    <h2 className="text-2xl font-display font-black text-[#002A45] uppercase mb-6">{item.title}</h2>
        ...
        <div className="bg-[#002A45] p-12 lg:p-24 text-white shadow-premium relative overflow-hidden flex flex-col lg:flex-row items-center gap-16 border-l-8 border-[#9ABE00] mb-24">
          ...
          <div className="lg:w-1/2 relative z-10">
            ...
            <p className="text-lg font-bold text-[#9ABE00] uppercase tracking-widest mb-10">
          ...
          <div className="lg:w-1/2 bg-white/5 backdrop-blur-sm p-12 border border-white/10 relative z-10">
            <TrendingUp size={48} className="text-[#9ABE00] mb-8" />
            ...
            <button className="w-full py-4 border border-[#9ABE00] text-[#9ABE00] font-display font-black text-[11px] tracking-widest uppercase hover:bg-[#9ABE00] hover:text-[#002A45] transition-all shadow-2xl">
